...
**Restrictions**
* The calendar-id must either only be upper- and lowercase characters (e. g. private or work), or special characters must be escaped, ref. https://www.w3schools.com/tags/ref_urlencode.asp (e.g. 'calendar1' -> 'calendar%31' or 'private-home' -> 'private%2Dhome')
